...
// custom lang
$string['opendrawerindex'] = 'Index';
$string['opendrawerblocks'] = 'Support material';
$string['closecourseindex'] = 'Close Index';
$string['closeblockdrawer'] = 'Close Support Material';
$string['prev_activity_tooltip'] = 'Go back to the previous activity';
...
$string['cellphone'] = 'Cellphone for Contact';
$string['facebook_link'] = 'Facebook Link';
$string['instagram_link'] = 'Instagram Link';
$string['linkedin_link'] = 'Linkedin link';
$string['youtube_link'] = 'YouTube Link';
$string['phone_desc'] = 'Contact phone number. Appears above the main menu.';
$string['contact_email'] = 'E-mail for contact';
$string['contact_email_desc'] = 'E-mail for contact. Appears above the main menu.';
$string['cellphone_desc'] = 'Contact cell phone. Appears above the main menu.';
$string['facebook_link_desc'] = 'Facebook link. Appears above the main menu.';
$string['instagram_link_desc'] = 'Instagram link. Appears above the main menu.';
